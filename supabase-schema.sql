-- ═══════════════════════════════════════════════
--  KORATEX ERP — Schema completo para Supabase
...
CREATE TABLE IF NOT EXISTS rutas_despacho (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS rutas_despacho_paradas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE SEQUENCE IF NOT EXISTS pedido_seq START 50;
...
-- Usuarios (contraseña: koratex2025)
INSERT INTO usuarios (nombre, email, password_hash, rol_id) VALUES
  ('Administrador',    'admin@koratex.com',      '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 1),
  ('Ana Comercial',    'comercial@koratex.com',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 2),
  ('Pedro Logística',  'logistica@koratex.com',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 3),
  ('Rosa Finanzas',    'finanzas@koratex.com',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 4)
ON CONFLICT DO NOTHING;

INSERT INTO tipos_cliente (nombre, dias_credito, lista_precios) VALUES
  ('oro',60,'A'),('plata',30,'B'),('bronce',15,'C')
ON CONFLICT DO NOTHING;

INSERT INTO zonas (nombre, km_ref) VALUES
...
INSERT INTO clientes (codigo,nombre,ruc,tipo_id,zona_id,direccion,lat,lng,limite_credito) VALUES
...
INSERT INTO productos (codigo,nombre,tipo_id,presentacion,precio_lista_a,precio_lista_b,precio_lista_c,costo_produccion,peso_kg) VALUES
...
INSERT INTO inventario_pt (producto_id, stock_total, stock_reservado)
SELECT p.id,
  CASE p.codigo
    WHEN 'KTX-001' THEN 480 WHEN 'KTX-002' THEN 620
    WHEN 'KTX-003' THEN 190 WHEN 'KTX-004' THEN 340 WHEN 'KTX-005' THEN 210
    WHEN 'KTX-006' THEN 280 WHEN 'KTX-007' THEN 390 WHEN 'KTX-008' THEN 150
  END,
  CASE p.codigo
    WHEN 'KTX-001' THEN 40 WHEN 'KTX-002' THEN 60
    WHEN 'KTX-003' THEN 20 WHEN 'KTX-004' THEN 30 WHEN 'KTX-005' THEN 10
    WHEN 'KTX-006' THEN 25 WHEN 'KTX-007' THEN 50 WHEN 'KTX-008' THEN 15
  END
...
INSERT INTO materias_primas (codigo,nombre,unidad,stock_actual,stock_minimo,stock_maximo,consumo_mensual,costo_unitario,proveedor_id)
...
INSERT INTO vehiculos (placa,nombre,conductor,capacidad_kg) VALUES
